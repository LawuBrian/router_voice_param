...
export const ROUTER_ASSETS: RouterAsset[] = [
  ...
  // ========================================
  // TP-Link MR600 Specific Assets (4G LTE Router)
  // LED lights are WHITE on this model
  // ========================================
  {
    asset_id: 'tplink_mr600_led_layout',
    vendor: 'tplink_4g',
    firmware: 'v5',
    node_id: 'physical_power_led',
    type: 'screenshot',
    url: `${ASSET_BASE_URL}/tplink-mr600/tplink_mr600_led_layout.jpg`,
    alt_text: 'TP-Link MR600 LED layout: Power, Internet, WiFi 2.4G, WiFi 5G, Signal bars, LAN - all WHITE when active',
    landmarks: ['power_led', 'internet_led', 'wifi_24g', 'wifi_5g', 'signal_bars', 'lan_led'],
  },
  {
    asset_id: 'tplink_mr600_back_panel',
    vendor: 'tplink_4g',
    firmware: 'v5',
    node_id: 'physical_wan_cable_check',
    type: 'screenshot',
    url: `${ASSET_BASE_URL}/tplink-mr600/tplink_mr600_back_panel.png`,
    alt_text: 'TP-Link MR600 back panel showing WAN/LAN ports, power port, reset button, and SIM slot',
    landmarks: ['wan_lan_port', 'lan_ports', 'power_port', 'reset_button', 'sim_slot'],
  },
  {
    asset_id: 'tplink_mr600_reset_button',
    vendor: 'tplink_4g',
    firmware: 'v5',
    node_id: 'router_factory_reset_locate',
    type: 'screenshot',
    url: `${ASSET_BASE_URL}/tplink-mr600/tplink_mr600_reset_button.png`,
    alt_text: 'TP-Link MR600 reset button pinhole location on back panel',
    landmarks: ['reset_pinhole'],
  },
  {
    asset_id: 'tplink_mr600_login',
    vendor: 'tplink_4g',
    firmware: 'v5',
    node_id: 'router_login_prompt',
    type: 'screenshot',
    url: `${ASSET_BASE_URL}/tplink-mr600/router_login_prompt.png`,
    alt_text: 'TP-Link MR600 login page with password field',
    landmarks: ['password_field', 'login_button'],
  },
  {
    asset_id: 'tplink_mr600_dashboard',
    vendor: 'tplink_4g',
    firmware: 'v5',
    node_id: 'router_dashboard_confirm',
    type: 'screenshot',
    url: `${ASSET_BASE_URL}/tplink-mr600/router_dashboard_confirm.png`,
    alt_text: 'TP-Link MR600 main dashboard showing network map, internet status, and signal strength',
    landmarks: ['network_map', 'internet_status', 'signal_strength', 'connected_devices'],
  },
  {
    asset_id: 'tplink_mr600_wan_disconnected',
    vendor: 'tplink_4g',
    firmware: 'v5',
    node_id: 'wan_status_check',
    type: 'screenshot',
    url: `${ASSET_BASE_URL}/tplink-mr600/wan_status_check _disconnected.png`,
    alt_text: 'TP-Link MR600 showing disconnected/no internet status',
    landmarks: ['status_disconnected', 'error_message'],
  },
  {
    asset_id: 'tplink_mr600_no_sim',
    vendor: 'tplink_4g',
    firmware: 'v5',
    node_id: 'physical_sim_check',
    type: 'screenshot',
    url: `${ASSET_BASE_URL}/tplink-mr600/tplink_mr600_no_sim.png`,
    alt_text: 'TP-Link MR600 showing No SIM card detected error',
    landmarks: ['no_sim_error'],
  },
  {
    asset_id: 'tplink_mr600_addressbar',
    vendor: 'tplink_4g',
    firmware: 'v5',
    node_id: 'local_browser_test',
    type: 'screenshot',
    url: `${ASSET_BASE_URL}/tplink-mr600/addressbar_tplink.png`,
    alt_text: 'Browser address bar showing tplinkmodem.net',
    landmarks: ['address_bar', 'url'],
  },
  {
    asset_id: 'tplink_mr600_physical_setup',
    vendor: 'tplink_4g',
    firmware: 'v5',
    node_id: 'entry_router_identify',
    type: 'screenshot',
    url: `${ASSET_BASE_URL}/tplink-mr600/physical-setup-image.png`,
    alt_text: 'TP-Link MR600 physical setup diagram',
    landmarks: ['router', 'connections'],
  },
  {
    asset_id: 'tplink_mr600_connect_device',
    vendor: 'tplink_4g',
    firmware: 'v5',
    node_id: 'local_wifi_connected',
    type: 'screenshot',
    url: `${ASSET_BASE_URL}/tplink-mr600/connect_smartdevice.png`,
    alt_text: 'Connect smart device to TP-Link MR600 WiFi',
    landmarks: ['wifi_connection', 'device'],
  },
];
