...
export const DIAGNOSTIC_NODES: DiagnosticNode[] = [
  ...
  // ========================================
  {
    ...
    expected_answers: {
      ...
      'yeah': 'entry_router_identify',
      'yep': 'entry_router_identify',
      'ready': 'entry_router_identify',
      'sure': 'entry_router_identify',
      'ok': 'entry_router_identify',
      'okay': 'entry_router_identify',
      'absolutely': 'entry_router_identify',
      'definitely': 'entry_router_identify',
      "let's go": 'entry_router_identify',
      'lets go': 'entry_router_identify',
      'go ahead': 'entry_router_identify',
      'start': 'entry_router_identify',
      'no': 'entry_postpone',
      'not now': 'entry_postpone',
      'later': 'entry_postpone',
      'nope': 'entry_postpone',
    },
    actions_allowed: [],
  ...
  // ========================================
  {
    ...
    expected_answers: {
      ...
      'lit': 'physical_internet_led',
      'lit up': 'physical_internet_led',
      'yes': 'physical_internet_led',
      'orange': 'physical_power_issue',
      'amber': 'physical_power_issue',
      'yellow': 'physical_power_issue',
      'blinking': 'physical_power_booting',
      'flashing': 'physical_power_booting',
      'off': 'physical_power_off',
      'no light': 'physical_power_off',
      'nothing': 'physical_power_off',
    },
    actions_allowed: [],
    escalation_conditions: {
      user_uncertain: true,
  ...
  },
  {
    ...
    expected_answers: {
      ...
      'lit': 'local_network_check',
      'lit up': 'local_network_check',
      'yes': 'local_network_check',
      'orange': 'physical_wan_cable_check',
      'amber': 'physical_wan_cable_check',
      'yellow': 'physical_wan_cable_check',
      'red': 'physical_wan_cable_check',
      'blinking': 'physical_wan_connecting',
      'flashing': 'physical_wan_connecting',
      'off': 'physical_wan_cable_check',
      'no light': 'physical_wan_cable_check',
      'nothing': 'physical_wan_cable_check',
    },
    actions_allowed: [],
    escalation_conditions: {
      user_uncertain: true,
