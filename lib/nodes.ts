...
export const DIAGNOSTIC_NODES: DiagnosticNode[] = [
  ...
  // ========================================
  {
    ...
    voice_instruction: "Hello! I'm Akili, your internet support assistant. I'll help you fix your connection issue step by step. Are you ready to begin?",
  ...
  },
  {
    ...
    voice_instruction: "Now let's access your router's settings page. Open a web browser and type tplinkmodem.net in the address bar, then press Enter. If that doesn't work, try 192.168.1.1. Do you see a login page?",
  ...
  },
  {
    ...
    voice_instruction: "Look at the back of your router for a tiny hole labeled 'Reset' or 'RST'. It's usually recessed so you'll need a paperclip, pin, or SIM card ejector tool to press it. Have you found the reset hole?",
    allowed_assets: ['factory_reset_guide', 'reset_button_location'],
    expected_answers: {
